...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([html.H4('Churn type distribution')], width=9),
    ...
    dbc.Row([
        dbc.Col([
            ...
            dbc.Row([
                dcc.Dropdown(
                    id='app-use-dropdown',
                    options=[{'label': app_use, 'value': app_use} for app_use in df['App_use'].unique()],
                    multi=True,
                    placeholder='App use',
                    style={'background-color': '#F3F3F7', 'border-radius': '20px', 'border': '0px'})
            ]),
            ...
            dbc.Row([
                dcc.Dropdown(
                    ...
                    options=[{'label': card_use, 'value': card_use} for card_use in df['Card_use'].unique()],
                    multi=True,
            ...
            dbc.Row([
                dcc.Dropdown(
                    ...
                    options=[{'label': cs_contact, 'value': cs_contact} for cs_contact in df['CS_contact'].unique()],
                    multi=True,
            ...
            dbc.Row([
                dcc.Dropdown(
                    ...
                    options=[{'label': shopping_search, 'value': shopping_search} for shopping_search in df['Shopping_search'].unique()],
                    multi=True,
...
def update_df(selected_markets, selected_age_groups, selected_genders, #selected_dates,
    ...
    # Scatter plot
    scatter_fig = px.scatter(filtered_df, x="Orders_5y", y="Orders_1y", title='Scatter plot of number of orders',
